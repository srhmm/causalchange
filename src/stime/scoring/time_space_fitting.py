...
from src.stime.utils.util import data_scale
...
def fit_functional_model_time_space(
    ...
    for context in set(contexts):
        ...
        for regime in set(regimes):
            gp_time_space[context][regime]= fit_functional_model_r_c(context, regime, scoring_function, subsampling_approach, data_C, windows_T, target_links, target, contexts, regimes, return_models)
...
def fit_MARS_regression_spline(data_C, pa_i, data_pa_i, data_node_i):
    ...
    :return:
    """
    from src.stime.scoring.models.spline_mdl import Slope
