...
from causalchange.core.require import require_rpt
...
class ChangepointDetection:
    ...
    def detect(
        ...
        *,
        ...
        if self.cfg.changepoint_mode == ChangepointMode.SKIP:
            self.diagnostics_ = {
                "mode": "none",
        ...
        if self.cfg.changepoint_mode == ChangepointMode.ORACLE:
        ...
        if self.cfg.changepoint_mode != ChangepointMode.DETECT:
            raise ValueError(f"Unsupported changepoint mode: {self.cfg.changepoint_mode}")
