...
class IvMode(Enum):
    """type of intervention/heterogeneity in synthetic data: synthetic data from iid distribution, mult context, w unknown mixing, or sergio-simulated"""
    #ATOMIC = 'atomic' #NEEDED?
    IID = 'iid'
    MIXING = 'mixing'
