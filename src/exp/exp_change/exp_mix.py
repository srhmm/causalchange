...
from src.exp.exp_change.config_mix import Options, ExpType

from src.exp.exp_change.run.run_cases import run_cases

if __name__ == "__main__":
    """
    >>> python run_exp_mix.py -e 0
    """
    import sys
    import argparse
    import logging
    ...
    ap.add_argument("-r", "--reps", default=50, type=int)
    ...
    ap.add_argument("-wd", "--write_dir", default="res_mix/")
    ap.add_argument("-pd", "--plot_dir", default="plts_mix/")
    ap.add_argument("-rd", "--read_dir", default="res_mix/")
