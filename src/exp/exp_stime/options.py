...
class Options:
    ...
    parameters_to_change = {
        'N': 'nodes_N', 'T': 'timelen_T', 'D': 'datasets_D', 'CPS': 'cutpoints_CPS',
        'R': 'regimes_R', 'C': 'contexts_C', 'I': 'interventions_I', 'IVS': 'intervention_strength_S',
    }
    ...
    def inc_seed(self): self.seed = self.seed + 1