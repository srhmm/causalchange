...
from src.exp.exp_stime.utils.gen_timeseries import get_regime_mask


def plot_timeseries_regimes_contexts(data, regime_partition, figsize=(15,3), title=""):
    ...
    for n_context, ts_context in data.datasets.items():
        ...
        plot_timeseries_regimes(ts_context_frame, figsize=figsize, regime_mask=regime_mask)
        plt.suptitle(f"Context {n_context}") if title == "" else plt.suptitle(title)
        plt.show()
...
COL_DBLUE = '#034f84'
COL_VIO ='#654286'
COL_REDORANGE = '#e15c4e'
COL_RED = '#e44a52'
COL_ORANGEYELL = '#f9cb6e'
COL_YELL = '#ffbc15'
COL_LGREEN = '#86ba71'
COL_GREENBLUE = '#007a86'
COL_PURP = '#8e4988'
COL_VIOL = '#7C4893'
COL_ORANGE ='#eb794e'
COL_SUN ='#ffa600'
COL_TEAL ='#005d80'
COL_TURQUOISE = '#61AAC0'
COL_LIME = '#D8DE3F'
COL_GRAY = '#616161'
COL_SCHEME = [COL_DBLUE, COL_GOLDEN, COL_GREEN, COL_REDORANGE, COL_LBLUE,COL_VIO, COL_TURQUOISE,COL_LIME,COL_GRAY,
              COL_VIOL,COL_TEAL,COL_SUN, COL_DBLUE, COL_GOLDEN, COL_GREEN, COL_REDORANGE, COL_LBLUE,COL_VIO, COL_TURQUOISE,COL_LIME,COL_GRAY,
              COL_VIOL,COL_TEAL,COL_SUN, COL_DBLUE, COL_GOLDEN, COL_GREEN, COL_REDORANGE, COL_LBLUE,COL_VIO, COL_TURQUOISE,COL_LIME,COL_GRAY,
              COL_VIOL,COL_TEAL,COL_SUN, COL_DBLUE, COL_GOLDEN, COL_GREEN, COL_REDORANGE, COL_LBLUE,COL_VIO, COL_TURQUOISE,COL_LIME,COL_GRAY,
              COL_VIOL,COL_TEAL,COL_SUN, COL_DBLUE, COL_GOLDEN, COL_GREEN, COL_REDORANGE, COL_LBLUE,COL_VIO, COL_TURQUOISE,COL_LIME,COL_GRAY,
              COL_VIOL,COL_TEAL,COL_SUN]
...
def _add_timeseries_regimes(
    ...
    for j in range(nb_components):
        ...
        if mask is not None or regime_mask is not None:
            maskseries = mask[:, j] if mask is not None else regime_mask[:, j]
