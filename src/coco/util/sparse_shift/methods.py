...
from src.coco.util.sparse_shift.utils import dag2cpdag, cpdag2dags
from src.coco.util.sparse_shift.testing import test_dag_shifts
...
def _construct_augmented_cpdag(cpdag):
    from src.coco.util.sparse_shift.utils import create_causal_learn_cpdag
    from src.coco.util.sparse_shift.causal_learn.GraphClass import CausalGraph
...
class AugmentedPC:
    ...
    def add_environment(self, X):
        ...
        from src.coco.util.sparse_shift.causal_learn.SkeletonDiscovery import augmented_skeleton_discovery
